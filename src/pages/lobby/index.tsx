...
const Lobby = () => {
  ...
  const musicTitles = ["Is It Over Now?", "The Great War", "End Game", "Born To Die"];
  ...
  return (
    ...
    >
      ...
      <div className="flex grow flex-col h-screen justify-start items-center"
        style={

          background == 0 ? {
            backgroundImage: `url('/images/background/spring.png')`, backgroundSize: 'cover',
            backgroundPosition: 'center',
          } :
            background == 1 ? {
              backgroundImage: `url('/images/background/summer.png')`, backgroundSize: 'cover',
              backgroundPosition: 'center',
            } :
              background == 2 ? {
                backgroundImage: `url('/images/background/autumn.jpeg')`, backgroundSize: 'cover',
                backgroundPosition: 'center',
              } :
                background == 3 ? {
                  backgroundImage: `url('/images/background/winter.jpeg')`, backgroundSize: 'cover',
                  backgroundPosition: 'center',
                } :
      ...
      <div>
        {isSidebarVisible && (<div className="w-96 p-5">
          ...
          <div className="grid overflow-x-scroll p-2">
            <div className="flex flex-row gap-2 ">
              <div className="w-40  rounded-lg bg-yellow-100 hover:ring-4 ring-purple-400"
                onClick={() => { setBackground(0) }}>
                <Image src={Image1} alt="spring" className="h-24 rounded-tl-lg rounded-tr-lg" />
                <div className="p-1 text-center tracking-wide">Spring</div>
              </div>
              <div className="w-40  rounded-lg bg-blue-100 hover:ring-4 ring-purple-400 "
                onClick={() => { setBackground(1) }}>
                <Image src={Image2} alt="summer" className="h-24 rounded-tl-lg rounded-tr-lg" />
                <div className="p-1 text-center tracking-wide">Summer</div>
              </div>
              <div className="w-40  rounded-lg bg-red-100 hover:ring-4 ring-purple-400"
                onClick={() => { setBackground(2) }}>
                <Image src={Image3} alt="autumn" className="h-24 rounded-tl-lg rounded-tr-lg" />
                <div className="p-1 text-center tracking-wide">Autumn</div>
              </div>
              <div className="w-40  rounded-lg bg-gray-200 hover:ring-4 ring-purple-400"
                onClick={() => { setBackground(3) }}>
                <Image src={Image4} alt="winter" className="h-24 rounded-tl-lg rounded-tr-lg" />
          ...
          <select value={musicTitle} onChange={handleSelectChange} className="w-full ring-2 ring-gray-300 rounded-lg p-2 
          hover:ring-gray-400">
