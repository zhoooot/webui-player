...
const RankUser: React.FC<RankUserProps> = ({points}) => {
  ...
  return (
    ...
    " style={{
      ...
      <motion.div className="font-bold text-2xl self-center text-white drop-shadow-[2px_2px_var(--tw-shadow-color)] shadow-black m-6 "
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      ...
      <motion.div className="flex justify-center items-center flex-col"
       ...
       transition={{ duration: 1, delay: 1}} >
        <div className="w-64 h-64  rounded-full bg-gradient-segments animate-spin-slow"
          style={{
      ...
      <motion.div className="font-bold text-2xl self-center text-white drop-shadow-[2px_2px_var(--tw-shadow-color)] shadow-black "
       initial={{ opacity: 0 }}
       animate={{ opacity: 1 }}
       transition={{ duration: 1, delay: 2}} >Knowledge champ!</motion.div>
